...
function $80d9b85e1e4f5d21$export$c106935194495501({ globalThis: globalThis = eval?.("this") } = {}) {
    return class _UniCompartment {
        static #evaluatorFactory = "eval" in globalThis ? new Function("$", `with($){return a=>eval(a);}`) : ($)=>{
            throw ``;
        };
        #opts;
        constructor(opts){
...
export {$80d9b85e1e4f5d21$export$c106935194495501 as createRaw};
